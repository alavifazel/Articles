...
\begin{document}
	...
	In these transformers, the current that flows through the parallel elements ($R_c$ and $X_m$) is a fraction of the current in series elements.
	...
	Furthermore if the transformer is designed for more than 1 MVA powers, the impedance of resistance element $R_e$ is negligible compared to the inductance $X_e$ and can be discarded. 
	Hence:
	...
	This circuit is as simplified as we can get; And it is used for modeling power transformers in engineering applications.
